...
<title>baseMapSample</title>
	...
	<script src="<c:url value='/resources/js/map/ol.js'/>"></script>
	<script src="<c:url value='/resources/js/map/proj4.js'/>"></script>
	<script src="<c:url value='/resources/js/map/transCoord.js'/>"></script>
	...
	<script src="<c:url value='/resources/js/map/apiVectorSample.js'/>"></script>
